...
public class AudioServiceEventHandler(
    ...
    IAudioService audioService)
{
    ...
    {
        var textChannel = await GuildChannelUtil.GetBotGuildChannel(dbService, discordSocketClient, args.Player.GuildId)
        ...
        var embed = EmbedCreator.CreateEmbed("Now Playing",
            $"[{args.Track.Title}]({args.Track.Uri})\n{args.Track.Author}\nDuration: {TimeSpanFormatter.FormatDuration(args.Track.Duration)}",

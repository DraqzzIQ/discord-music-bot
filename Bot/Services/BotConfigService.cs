...
public class BotConfigService : ConfigService
{
    public override string DbConnectionString { get; } = Environment.GetEnvironmentVariable("DB_CONNECTION_STRING") ?? throw new ArgumentNullException(nameof(DbConnectionString));
